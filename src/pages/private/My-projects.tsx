...
//   return (
//     <div className="flex items-center justify-center h-full flex-col gap-10 mx-auto dark:text-black">
//       <h1 className="text-3xl text-center dark:text-white">Vos projets</h1>
//       <section className="flex justify-start sm:flex-row flex-col gap-6 overflow-x-scroll w-full  items-center py-7 px-2">
//         {projects?.length > 0 &&
...
//         <button
//           type="button"
//           className="text-6xl text-white dark:text-darkTheme text-center rounded-full w-14 h-14 flex items-center justify-center bg-darkgold2 dark:bg-gold hover:scale-105 transition"
//         >
//           +
//         </button>
//       </section>
...
function MyProjects() {
  ...
  return (
    <div className="flex items-center justify-center h-full flex-col gap-10 mx-auto dark:text-black">
      <h1 className="text-3xl text-center dark:text-white">Vos projets</h1>
      <section className="flex justify-start sm:flex-row flex-col gap-6 overflow-x-auto w-full items-center py-7 px-2">
        {projects?.length > 0 &&
          projects?.map((project) => (
            <div
              key={project.id}
