...
function LegalNotices() {
  ...
  return (
    <div className="px-10 md:px-20 backdrop-blur-mini mb-28">
      <h2>Définitions</h2>
      <p>
        ...
        <Link to="https://www.develup-potfolio.com">
          https://www.develup-potfolio.com
        </Link>{' '}
      ...
      <p>
        <strong>Propriétaire</strong> : SAS Develup Capital social de 10€ Numéro
        de TVA: 982908 – 09 rue fictive 00001 Ville fictive
        <br />
        <strong>Responsable publication</strong> : Develup – develup33@gmail.com
        <br />
        Le responsable publication est une personne physique ou une personne
        morale.
        <br />
        <strong>Webmaster</strong> : Develup – develup33@gmail.com
        <br />
        <strong>Hébergeur</strong> : Heroku –{' '}
        <Link to="https://www.heroku.com/">https://www.heroku.com</Link> 00001
        Ville fictive 00982828900
        <br />
        <strong>Délégué à la protection des données</strong> : Develup –
        develup33@gmail.com
        <br />
      </p>
      ...
      <p>
        ...
        responsable du traitement des Données Personnelles est : Develup.{' '}
        <Link to="https://www.develup-potfolio.com">
          https://www.develup-potfolio.com
        </Link>{' '}
        est représenté par Develup, son représentant légal.
      </p>
